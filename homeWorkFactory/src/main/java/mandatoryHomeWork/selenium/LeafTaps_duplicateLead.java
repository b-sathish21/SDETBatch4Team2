...
public class duplicateLead_LeafTaps {
	...
	public static By duplicateLead_btn = By.xpath("//a[text() = 'Duplicate Lead']");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		sndTxt2Ele(wait, act, dr, frstNm_txtBx, "Sathish");
		
		//Enter LastName Field Using id Locator
		sndTxt2Ele(wait, act, dr, lstNm_txtBx, "Baskaran");
		...
		sndTxt2Ele(wait, act, dr, emlAdrs_txtBx, "b.sathish21@gmail.com");
		...
		clckEle(wait, act, dr, duplicateLead_btn);
		
		//Clear the CompanyName Field And Enter new CompanyName
		clckEle(wait, act, dr, companyName_txt);
		clrEle(wait, act, dr, companyName_txt);
		sndTxt2Ele(wait, act, dr, companyName_txt, "Fire KBS");
		
		//Clear the FirstName Field And Enter new FirstName
		clckEle(wait, act, dr, frstNm_txtBx);
		clrEle(wait, act, dr, frstNm_txtBx);
		sndTxt2Ele(wait, act, dr, frstNm_txtBx, "Thambi");
